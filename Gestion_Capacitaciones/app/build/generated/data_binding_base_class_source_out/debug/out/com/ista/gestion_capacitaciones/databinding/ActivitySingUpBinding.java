...
public final class ActivitySingUpBinding implements ViewBinding {
  ...
  private ActivitySingUpBinding(@NonNull ConstraintLayout rootView, @NonNull Button button3,
      @NonNull EditText editText, @NonNull EditText editTextText, @NonNull ImageView imageView3,
  ...
  public static ActivitySingUpBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySingUpBinding((ConstraintLayout) rootView, button3, editText, editTextText,
          imageView3, imageView5, imageView6, imageView8, imageView9, textView4, textView5,
          textView6, textView7);
    }
