...
public final class ActivityProgramaCursosBinding implements ViewBinding {
  ...
  @NonNull
  public static ActivityProgramaCursosBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityProgramaCursosBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_programa_cursos, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
